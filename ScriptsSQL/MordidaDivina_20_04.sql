USE [master]
GO
/****** Object:  Database [MordidaDivina]    Script Date: 20/4/2024 19:49:41 ******/
...
USE [MordidaDivina]
GO
/****** Object:  Table [dbo].[carrito]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[categorias]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[detallePedidos]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[direcciones]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[errores]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[maestroPedido]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[productos]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[roles]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[usuarios]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[categorias] ([id], [nombre]) VALUES (1, N'Pastelería')
GO
INSERT [dbo].[categorias] ([id], [nombre]) VALUES (2, N'Repostería')
GO
INSERT [dbo].[categorias] ([id], [nombre]) VALUES (3, N'Galletas')
GO
INSERT [dbo].[categorias] ([id], [nombre]) VALUES (4, N'Chocolates o suspiros')
GO
INSERT [dbo].[categorias] ([id], [nombre]) VALUES (5, N'Variados')
GO
...
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (10, 5, N'Caja del día de la Madre', N'Galletas de leche o fudge, alfajores corazones de chocolate, brigadeiros, cupcakes rellenos, chocolates y suspiros', CAST(15000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-10.png?timestamp=638491522244511704')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (11, 1, N'Cupcakes de vainilla', N'Cupcakes de vainilla cubierto con chantilly o merengue', CAST(8500.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-11.png?timestamp=638491533915972516')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (12, 2, N'Empanadas', N'Caja de 6 empanadas de dulce de leche, higos, chiverre o piña', CAST(3000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-12.png?timestamp=638491537744297319')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (13, 1, N'Queque de chocolate', N'Queque de chocolate relleno de fudge y leche condensada cocinada', CAST(12000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-13.png?timestamp=638491539653640474')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (14, 1, N'Cupcakes de chocolate', N'Cupcakes de chocolate cubierto de ganache', CAST(6000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-14.png?timestamp=638491542112276835')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (15, 1, N'Queque de chocolate y naranja', N'Queque marmoleado de chocolate y naranja con lustre de maracuyá', CAST(18000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-15.png?timestamp=638491544493689964')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (16, 1, N'Red velvet', N'Red velvet con frutos rojos, delicioso y equilibradamente dulce ', CAST(35000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-16.png?timestamp=638491555346321605')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (17, 4, N'Choco bombas', N'Choco bombas rellenas de chocolate en polvo y marshmallow', CAST(5000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-17.png?timestamp=638491560006630568')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (18, 4, N'Paletas de suspiro', N'Merengue azucarado con esencia de vainilla debidamente decorados  ', CAST(1500.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-18.png?timestamp=638492103015203442')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (19, 1, N'Pie de limón', N'Se caracteriza por su base de galletas maría, su pasta cremosa y merengue suizo', CAST(16000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-19.png?timestamp=638492105778953114')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (20, 1, N'Torta de Melocotón', N'Capas de bizcocho humedecido con almíbar de melocotón, chantilly y trocitos de melocotón ', CAST(18000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-20.png?timestamp=638492107592214576')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (21, 1, N'Queque de chocolate', N'Base de queque de chocolate con relleno de dulce de leche y cobertura de ganache de chocolate', CAST(18500.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-21.png?timestamp=638492117961468471')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (22, 4, N'Suspiros o merengues', N'Caja de corazón con merengues en forma de flor con tonalidades rosadas y rojas ', CAST(10000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-22.png?timestamp=638492120200821646')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (23, 1, N'Brownies', N'Pastelitos dulces de chocolate en forma de corazón con trocitos de nuez y cobertura cremosa de distintos colores', CAST(2000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-23.png?timestamp=638492121995705509')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (24, 1, N'Queque Navideño', N'Queque moreno con frutas cristalizadas, pasas y ron', CAST(7000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-24.png?timestamp=638492212364438149')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (25, 1, N'Cupcakes marmoleados de vainilla y chocolate', N'Cupcakes marmoleados vainilla y chocolate, relleno de leche condensada cocinada y buttercream de Nutella', CAST(5500.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-25.png?timestamp=638492126769013544')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (26, 4, N'Suspiros', N'Bolsita de suspiros con arroz tostado cubierto de chocolate blanco', CAST(2500.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-26.png?timestamp=638492191475956650')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (27, 3, N'Queque de chocolate con barquillos', N'Queque de chocolate con relleno de leche condensada cocinada, barquillos de chocolate y m&m’s', CAST(20000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-27.png?timestamp=638492196614092191')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (28, 4, N'Alfajores', N'Caja de 12 mini alfajores rellenos de dulce de leche y azúcar en polvo', CAST(5000.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-28.png?timestamp=638492201367024595')
GO
INSERT [dbo].[productos] ([id], [categoriaId], [nombre], [descripcion], [precio], [rutaImagen]) VALUES (30, 1, N'Queque tradicional de cumpleaños', N'Queque tradicional de vainilla con relleno de leche condensada cocinada, higos y almendras', CAST(16500.00 AS Decimal(10, 2)), N'https://micnqvjrnzhesjgnogsc.supabase.co/storage/v1/object/public/imagenes-producto/producto-30.png?timestamp=638492286297902100')
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__usuarios__AB6E6164FA77B50A]    Script Date: 20/4/2024 19:49:41 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[ActualizarCategoria]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ActualizarDireccionMantenimiento]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ActualizarEstadoPedido]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ActualizarImagenProducto]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ActualizarProducto]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ActualizarUsuarioMantenimiento]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AgregarCarrito]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarCarrito]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarCategoria]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarDetallePedidos]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarPedidos]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarPedidosMantenimiento]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarProducto]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ConsultarProductos]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarTiposCategoria]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarTiposRoles]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarUsuario]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarUsuarioMantenimiento]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[ConsultarUsuarios]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[EliminarCarrito]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[EliminarCategoria]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[EliminarProducto]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[EliminarUsuarioMantenimiento]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[EliminarUsuarioMantenimiento]
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[EncontrarPorCorreo]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[EnvioCodigoAcceso]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END	
GO
/****** Object:  StoredProcedure [dbo].[IniciarSesionUsuario]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ModificarUsuario]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[PagoCarrito]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[RegistrarCategoria]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[RegistrarDireccion]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[RegistrarNuevaContrasenna]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[RegistrarProducto]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[RegistrarUsuario]    Script Date: 20/4/2024 19:49:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
